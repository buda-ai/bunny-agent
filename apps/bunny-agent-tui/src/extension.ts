 ...
 *
 * 1. Registers web_search, web_fetch, generate_image tools from runner-harness.
 * 2. Registers custom OpenAI-compatible provider if OPENAI_BASE_URL is set,
 *    so `--model openai:<any-model>` works with proxy endpoints.
 */
