 ...
 * 4. Loads Bunny's shared Pi extension pack: safety gates, goal mode, plan mode,
 *    and subagents. This same pack is also used by runner-pi/daemon.
 */
...
import { bunnyPiExtension } from "@bunny-agent/runner-pi/bundled-extension";
