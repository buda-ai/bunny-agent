...
Keep workspace and session data across sandbox restarts:
...
**Dynamic install** (`skipBootstrap: false`): Installs `@sandagent/runner-cli@beta` via npm inside the sandbox. More flexible, slower startup.
...
| Provider | Best For | Persistent Volumes | Pre-built Images |
|----------|----------|-------------------|-----------------|
| **LocalSandbox** | Desktop apps, debugging | N/A (local FS) | N/A |
| **Sandock** | Cloud production | ✅ | ✅ |
| **E2B** | Cloud production | ✅ | ✅ |
| **Daytona** | Enterprise workspaces | ✅ | ✅ |
