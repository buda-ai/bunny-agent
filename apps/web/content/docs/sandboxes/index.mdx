...
| Provider | Best For | Persistent Volumes | Pre-built Images | Network Limits | Volume Public Access |
|----------|----------|--------------------|-----------------|----------------|----------------------|
| **LocalSandbox** | Desktop apps, debugging | N/A (local FS) | N/A | None | N/A |
| **Sandock** | Cloud production | ✅ | ✅ | None | ✅ |
