...
const BUNNY_PI_EXTENSION_PATH = path.join(
  path.dirname(fileURLToPath(import.meta.url)),
  "..",
  "bunny-pi-extension.js",
);
...
function getPiInvocation(args: string[]): { command: string; args: string[] } {
  const configuredCommand = process.env.BUNNY_AGENT_SUBAGENT_COMMAND;
