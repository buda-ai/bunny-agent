...
export interface BunnySafetyExtensionOptions {
  defaultPermissionMode?: PermissionMode;
}

export default function bunnySafetyExtension(
  pi: ExtensionAPI,
  options: BunnySafetyExtensionOptions = {},
): void {
  let permissionMode: PermissionMode =
    options.defaultPermissionMode ??
    normalizePermissionMode(process.env.BUNNY_AGENT_PERMISSION) ??
    "safe";
  ...
  function persistPermissionMode(): void {
