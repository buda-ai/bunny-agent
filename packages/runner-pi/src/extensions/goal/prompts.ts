/**
 * Codex-derived continuation prompt template, lifted verbatim from pi-goal v2
 * (https://github.com/PurpleMyst/pi-goal). Treats the user objective as
 * untrusted data so the agent can't be steered by an injected objective.
 */
