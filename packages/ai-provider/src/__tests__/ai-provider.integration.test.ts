...
describe("ai-provider Integration Tests", () => {
  ...
  it(
    "should create SandAgent provider",
    async () => {
  ...
  it(
    "should create language model with shorthand",
    async () => {
      const testDir = await mkdtemp(join(tmpdir(), "sandagent-test-"));
  ...
  it(
    "should stream text with AI SDK (mock mode)",
    async () => {
      const testDir = await mkdtemp(join(tmpdir(), "sandagent-test-"));
  ...
  it(
    "should support different model variations",
    async () => {
      const testDir = await mkdtemp(join(tmpdir(), "sandagent-test-"));
