...
export const ToolInput = ({ className, input, ...props }: ToolInputProps) => (
  <div className={cn("space-y-2 overflow-x-auto min-w-0 p-4", className)} {...props}>
    ...
    <div className="rounded-md">
      <CodeBlock
        ...
        language="json"
        className="[&_pre]:whitespace-pre-wrap [&_pre]:break-words border-none shadow-none bg-transparent [&_pre]:!bg-transparent [&_code]:!bg-transparent [&_span]:!bg-transparent"
      />
    </div>
  </div>
);
